...
public class SupplierPortalTool
{
    ...
    [Description("Sends an invitation email to a supplier with a link to apply to the request")]
    public async Task<string> SendSupplierInvitationAsync(
        [Description("The email body content for the invitation")] string body,
