...
import {
  ...
  handleFetchCredentialRequests,
  handleApproveCredentialRequest,
...
export function initUIHandler() {
  ...
  handler.set(UI_EVENTS.fetch_resource_credential_requests, handleFetchCredentialRequests);
  handler.set(UI_EVENTS.fetch_credential_schema_requirement, handleFetchCredentialSchemaRequirement);
  handler.set(UI_EVENTS.approve_credential_request, handleApproveCredentialRequest);
...
export function initCSHandler() {
  ...
  handler.set(CS_EVENTS.store_credential_schema_requirement, handleStoreCredentialSchemaRequirement);
  handler.set(CS_EVENTS.fetch_credential_schema_requirement, handleFetchCredentialSchemaRequirement);
