...
export const CS_EVENTS = {
  ...
  store_credential_schema_requirement: `${CS}-store-credential-schema-requirement`,
  fetch_credential_schema_requirement: `${CS}-${EVENT_TYPE.fetch_resource}-credential-schema-requirement`,
...
export const UI_EVENTS = {
  ...
  fetch_resource_credential_requests: `${UI}-${EVENT_TYPE.fetch_resource}-credential-requests`,
  fetch_credential_schema_requirement: `${UI}-${EVENT_TYPE.fetch_resource}-credential-schema-requirement`,
  approve_credential_request: `${UI}-${EVENT_TYPE.update_resource}-approve-credential-request`,
  deny_credential_request: `${UI}-${EVENT_TYPE.update_resource}-deny-credential-request`,
